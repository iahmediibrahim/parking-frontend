'use client'
import { Subscription, Ticket, Zone } from '@/core'
import {
	CheckinParams,
	Loader,
	Tabs,
...
export function GateClient({ gateId }: { gateId: string }) {
	...
	const { isConnected, messages } = useGateWebSocket(gateId)
